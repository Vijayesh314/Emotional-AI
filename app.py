...
STATIC_FOLDER = os.path.join(APP_ROOT, "static")  # recommended place for index.html, css, js

# Security / limits
MAX_CONTENT_LENGTH = int(os.getenv("MAX_CONTENT_LENGTH_BYTES", 10 * 1024 * 1024))  # 10 MB default
